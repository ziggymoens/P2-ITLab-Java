...
public class HerinneringOfflineMapper extends HerinneringMapper {
    ...
    private final File herinneringenOffline = new File("src/ongebruikt.offlineData/initData/Herinnering");
    ...
    private void leesHerinneringen() {
        try {
            FileInputStream fis = new FileInputStream("src/ongebruikt.offlineData/serieel/Herinnering.ser");
    ...
    public void schrijfHerinneringen() {
        try {
            FileOutputStream fos = new FileOutputStream("src/ongebruikt.offlineData/serieel/Herinnering.ser");
