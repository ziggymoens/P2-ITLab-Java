...
public class MediaOfflineMapper extends MediaMapper {
    ...
    private final File mediaenOffline = new File("src/ongebruikt.offlineData/initData/Media");
    ...
    private void leesMediaen() {
        try {
            FileInputStream fis = new FileInputStream("src/ongebruikt.offlineData/serieel/Media.ser");
    ...
    public void schrijfMedia() {
        try {
            FileOutputStream fos = new FileOutputStream("src/ongebruikt.offlineData/serieel/Media.ser");
