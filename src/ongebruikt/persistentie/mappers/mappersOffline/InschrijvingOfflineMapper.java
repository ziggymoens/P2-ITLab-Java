...
public class InschrijvingOfflineMapper extends InschrijvingMapper {
    ...
    private final File inschrijvingenOffline = new File("src/ongebruikt.offlineData/initData/Inschrijving");
    ...
    private void leesInschrijvingen() {
        try {
            FileInputStream fis = new FileInputStream("src/ongebruikt.offlineData/serieel/Inschrijving.ser");
    ...
    public void schrijfInschrijvingen() {
        try {
            FileOutputStream fos = new FileOutputStream("src/ongebruikt.offlineData/serieel/Inschrijving.ser");
