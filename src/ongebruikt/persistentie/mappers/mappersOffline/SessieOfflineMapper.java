...
public class SessieOfflineMapper extends SessieMapper {
    private final File gebruikersoffline = new File("src/ongebruikt.offlineData/initData/Sessies");
    ...
    public void leesSessies() {
        try {
            FileInputStream fis = new FileInputStream("src/ongebruikt.offlineData/serieel/Sessie.ser");
    ...
    public void schrijfSessies() {
        try {
            FileOutputStream fos = new FileOutputStream("src/ongebruikt.offlineData/serieel/Sessie.ser");
