...
public class AankondigingOfflineMapper extends AankondigingMapper {
    ...
    private final File aankondigingenOffline = new File("src/ongebruikt.offlineData/initData/Aankondiging");
    ...
    private void leesAankondigingen() {
        try {
            FileInputStream fis = new FileInputStream("src/ongebruikt.offlineData/serieel/Aankondiging.ser");
    ...
    public void schrijfAankondigingen() {
        try {
            FileOutputStream fos = new FileOutputStream("src/ongebruikt.offlineData/serieel/Aankondiging.ser");
