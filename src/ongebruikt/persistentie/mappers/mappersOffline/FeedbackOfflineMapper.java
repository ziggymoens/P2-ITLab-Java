...
public class FeedbackOfflineMapper extends FeedbackMapper {
    ...
    private final File feedbackOffline = new File("src/ongebruikt.offlineData/initData/Feedback");
    ...
    private void leesFeedback() {
        try {
            FileInputStream fis = new FileInputStream("src/ongebruikt.offlineData/serieel/Feedback.ser");
    ...
    public void schrijfFeedback() {
        try {
            FileOutputStream fos = new FileOutputStream("src/ongebruikt.offlineData/serieel/Feedback.ser");
